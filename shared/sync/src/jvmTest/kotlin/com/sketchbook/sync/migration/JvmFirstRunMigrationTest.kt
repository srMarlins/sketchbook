...
class JvmFirstRunMigrationTest {
    ...
    @Test
    fun mintsUuidWhenNeitherSidecarNorIdentityExists() = runTest {
        val catalog = setup()
    ...
    @Test
    fun reusesSidecarUuidWhenIdentityRowMissing() = runTest {
        val catalog = setup()
    ...
    @Test
    fun writesSidecarWhenIdentityExistsButSidecarMissing() = runTest {
        val catalog = setup()
        ...
        val migration = JvmFirstRunMigration(catalog, uuidGen = { error("should not be called") })
        val outcome = migration.run().toList()
    ...
    @Test
    fun isIdempotentOnSecondRun() = runTest {
        val catalog = setup()
    ...
    @Test
    fun sidecarWinsConflict() = runTest {
        val catalog = setup()
    ...
    @Test
    fun summaryCountsMatchOutcomes() = runTest {
        val catalog = setup()
