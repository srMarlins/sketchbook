...
class CloudDocTest {
    ...
    @Test
    fun readDocReturnsNullWhenAbsent() = runTest {
    ...
    @Test
    fun writeWithMustNotExistFailsWhenPresent() = runTest {
        val cloud = FakeCloudBackend()
    ...
    @Test
    fun writeCasFailsOnGenerationMismatch() = runTest {
        val cloud = FakeCloudBackend()
        cloud.writeDoc(key, Generation.ZERO, "a".encodeToByteArray()).getOrThrow()
    ...
    @Test
    fun writeCasSucceedsOnMatchingGeneration() = runTest {
        val cloud = FakeCloudBackend()
    ...
    @Test
    fun listDocsFiltersByPrefix() = runTest {
        val cloud = FakeCloudBackend()
