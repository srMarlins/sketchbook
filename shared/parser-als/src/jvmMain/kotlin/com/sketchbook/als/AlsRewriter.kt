...
private val INPUT_FACTORY: XMLInputFactory =
...
object AlsRewriter {
     ...
     */
    private fun hasMatchingSampleRef(
        gzipped: ByteArray,
        oldPaths: Set<String>,
    ): Boolean {
    ...
    private fun identityWithSampleRefEdits(
            ...
            when (reader.eventType) {
                XMLStreamConstants.START_ELEMENT -> {
                    BufferedEvent(
                        ...
                        attrs =
                            (0 until reader.attributeCount).map {
                ...
                XMLStreamConstants.CHARACTERS, XMLStreamConstants.SPACE -> {
                    BufferedEvent(
                        reader.eventType,
                        null,
                        emptyList(),
                ...
                XMLStreamConstants.PROCESSING_INSTRUCTION -> {
                    ...
                    BufferedEvent(reader.eventType, null, emptyList(), null, null, null, null, null)
                }
            }
        ...
        fun emit(e: BufferedEvent) {
            when (e.type) {
                ...
                XMLStreamConstants.CDATA -> {
                    writer.writeCData(e.text!!)
                }

                XMLStreamConstants.COMMENT -> {
                    writer.writeComment(e.text!!)
                }
    ...
    private fun applyEdit(
        ...
        val newRelativeToWrite: String? =
            edit.newRelativePath
