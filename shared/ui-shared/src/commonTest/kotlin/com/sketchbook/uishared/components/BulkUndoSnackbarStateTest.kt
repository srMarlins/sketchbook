...
class BulkUndoSnackbarStateTest {
    @Test fun showStartsFiveSecondCountdown() =
        runTest {
    ...
    @Test fun expiresAfterFiveSecondsAndCallsOnExpire() =
        runTest {
            var expired = false
            val state = BulkUndoSnackbarState(this)
    ...
    @Test fun secondShowReplacesFirstAndCommitsIt() =
        runTest {
    ...
    @Test fun undoFiresCallbackAndDismisses() =
        runTest {
            var undone = false
            val state = BulkUndoSnackbarState(this)
