...
class SqlJournalRepositoryTest {
    ...
    @Test
    fun appendThenObserveRecentReturnsNewestFirst() =
        runTest {
            val (_, repo) = setup()
    ...
    @Test
    fun undoLastRemovesAndReturnsMostRecent() =
        runTest {
    ...
    @Test
    fun roundTripsAllSixActionRecordVariants() =
        runTest {
            val (_, repo) = setup()
            val variants: List<ActionRecord> =
                listOf(
    ...
    @Test
    fun actionTypeColumnUsesStableTypeKeyNotClassName() =
        runTest {
    ...
    @Test
    fun selectJournalRecentIsDeterministicWhenTimestampsCollide() =
        runTest {
    ...
    @Test
    fun appendAutoFillsProjectNameAndPathFromCatalog() =
        runTest {
    ...
    @Test
    fun appendPreservesCallerSuppliedNameAndPathEvenForOrphanedProjectId() =
        runTest {
